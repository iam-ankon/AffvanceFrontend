...
export default function Page() {
  ...
  const handleGenerate = () => {
    ...
    createRequest(payload, {
      onSuccess: (response) => {
        ...
        if (!requestId) {
          toast.error('Content request created but no request id was returned.');
          return;
        }
  ...
  const { mutate: createRequest, isPending: isCreating } = useCreateContentRequest('copilot');
    ...
    <>
      ...
      <Main>
        ...
        <h1 className="mb-8 text-center text-3xl font-bold md:text-4xl">
          Copilot Single Article Generator
        </h1>
        ...
        <div className="bg-gradient-secondary min-h-screen">
          ...
          <div className="container mx-auto px-6 py-8">
            <div className="grid grid-cols-1 gap-8">
              <KeywordSection data={keywordData} onChange={setKeywordData} maxSelections={1} />
              ...
              <div className="grid grid-cols-1 gap-8 xl:grid-cols-3">
                ...
                <CommerceSection
                  ...
                  affiliateLinksLabel="Add Affiliate Link"
                  affiliateLinksMode="single"
                />
              </div>
